...
OUT_DIM = 3 #Количество выходных значений

H_DIM = 10 #Количество нейронов в первом слое (У меня он один)

x = np.array([7.9, 3.1, 7.5, 1.8]) #Веса, иначе, размеры цветка

#Векторы матричного слоя
...
class_names = ['Сетоса', 'Версиколор', 'Вирджинига']

print('Предполагаемое ростение:', class_names[pred_class])
